...
function SetWaterMark() {
    try {
        if (document.getElementById("gridRows") != null && document.getElementById("gridStyles") == null) {
            if (document.getElementsByClassName("WACScrollerWaterMark") == null || document.getElementsByClassName("WACScrollerWaterMark").length == 0) {
        ...
        // 预览
        if (document.getElementById("gridStyles") == null) {
