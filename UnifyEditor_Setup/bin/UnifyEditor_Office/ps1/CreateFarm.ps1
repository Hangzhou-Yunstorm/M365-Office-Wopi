param($IntetnalURL, $ExternalUrl="", $CertificateName="", $root)
...
if ($CertificateName -eq "" -or  $ExternalUrl -eq ""){
...
New-OfficeWebAppsFarm -InternalUrl $IntetnalURL -ExternalUrl $ExternalUrl -CertificateName $CertificateName -EditingEnabled -OpenFromUrlEnabled -Force
}
